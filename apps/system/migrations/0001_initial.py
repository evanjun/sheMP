# Generated by Django 2.1.5 on 2019-01-23 08:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, to='system.Menu', verbose_name='菜单授权')),
            ],
        ),
        migrations.CreateModel(
            name='Structure',
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='system.Structure'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
