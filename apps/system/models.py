...
class Menu(models.Model):
    ...
    @classmethod
    def get_menu_from_request_url(cls, url):
        return dict(Menu.objects.get(url=url))
...
class Structure(models.Model):
    ...
    parent = models.ForeignKey("self", blank=True, null=True, on_delete=models.SET_NULL, verbose_name="父类架构")
...
class UserProfile(AbstractUser):
    ...
    supervisor = models.ForeignKey("self", null=True, blank=True, verbose_name="上级主管", on_delete=models.SET_NULL)
